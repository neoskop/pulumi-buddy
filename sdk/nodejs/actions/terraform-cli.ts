...
export interface TerraformCLIState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type TerraformCLIArgs = AsInputs<TerraformCLIState>;

export interface TerraformCLIProps {
    url: string;
    html_url: string;
    action_id: number;
    execute_commands: string;
 ...
 */
export class TerraformCLI extends CustomResource {
    static __pulumiType = 'buddy:action:TerraformCLI';

    static get(name: string, id: Input<ID>, state?: Partial<TerraformCLIState>, opts?: CustomResourceOptions) {
        return new TerraformCLI(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is TerraformCLI {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === TerraformCLI.__pulumiType;
    }
    ...
    shell!: Output<string | undefined>;
    timeout!: Output<number | undefined>;
    trigger_conditions!: Output<TriggerCondition[] | undefined>;
    variables!: Output<Variable[] | undefined>;

    constructor(name: string, argsOrState: TerraformCLIArgs | TerraformCLIState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as TerraformCLIState | undefined;
            ...
            const args = argsOrState as TerraformCLIArgs | undefined;
        ...
        inputs['type'] = 'TERRAFORM';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(TerraformCLI.__pulumiType, name, inputs, opts);
    }
}
