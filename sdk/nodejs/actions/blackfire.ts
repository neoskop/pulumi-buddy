...
export interface BlackfireState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type BlackfireArgs = AsInputs<BlackfireState>;

export interface BlackfireProps {
    url: string;
    html_url: string;
    action_id: number;
    execute_commands: string[];
 ...
 */
export class Blackfire extends CustomResource {
    static __pulumiType = 'buddy:action:Blackfire';

    static get(name: string, id: Input<ID>, state?: Partial<BlackfireState>, opts?: CustomResourceOptions) {
        return new Blackfire(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is Blackfire {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === Blackfire.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: BlackfireArgs | BlackfireState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as BlackfireState | undefined;
            ...
            const args = argsOrState as BlackfireArgs | undefined;
        ...
        inputs['type'] = 'BLACKFIRE_PYTHON';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(Blackfire.__pulumiType, name, inputs, opts);
    }
}
