...
export interface AWSCDKCLIState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type AWSCDKCLIArgs = AsInputs<AWSCDKCLIState>;

export interface AWSCDKCLIProps {
    url: string;
    html_url: string;
    action_id: number;
    execute_commands: string;
 ...
 */
export class AWSCDKCLI extends CustomResource {
    static __pulumiType = 'buddy:action:AWSCDKCLI';

    static get(name: string, id: Input<ID>, state?: Partial<AWSCDKCLIState>, opts?: CustomResourceOptions) {
        return new AWSCDKCLI(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is AWSCDKCLI {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === AWSCDKCLI.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: AWSCDKCLIArgs | AWSCDKCLIState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as AWSCDKCLIState | undefined;
            ...
            const args = argsOrState as AWSCDKCLIArgs | undefined;
        ...
        inputs['type'] = 'AWS_CDK_CLI';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(AWSCDKCLI.__pulumiType, name, inputs, opts);
    }
}
