...
export type WPCLIArgs = AsInputs<WPCLIState>;

export interface WPCLIProps {
    url: string;
    html_url: string;
    action_id: number;
    execute_commands: string[];
 ...
 */
export class WPCLI extends CustomResource {
    static __pulumiType = 'buddy:action:WPCLI';

    static get(name: string, id: Input<ID>, state?: Partial<WPCLIState>, opts?: CustomResourceOptions) {
        return new WPCLI(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is WPCLI {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === WPCLI.__pulumiType;
    }
    ...
    config!: Output<string | undefined>;
    disabled!: Output<boolean | undefined>;
    env_key!: Output<string | undefined>;
    ...
    constructor(name: string, argsOrState: WPCLIArgs | WPCLIState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as WPCLIState | undefined;
            ...
            const args = argsOrState as WPCLIArgs | undefined;
        ...
        super(WPCLI.__pulumiType, name, inputs, opts);
    }
}
