...
export interface BuildAReactNativeAppState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type BuildAReactNativeAppArgs = AsInputs<BuildAReactNativeAppState>;

export interface BuildAReactNativeAppProps {
    url: string;
    html_url: string;
    action_id: number;
    commands: string[];
 ...
 */
export class BuildAReactNativeApp extends CustomResource {
    static __pulumiType = 'buddy:action:BuildAReactNativeApp';

    static get(name: string, id: Input<ID>, state?: Partial<BuildAReactNativeAppState>, opts?: CustomResourceOptions) {
        return new BuildAReactNativeApp(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is BuildAReactNativeApp {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === BuildAReactNativeApp.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: BuildAReactNativeAppArgs | BuildAReactNativeAppState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as BuildAReactNativeAppState | undefined;
            ...
            inputs['node_version'] = state?.node_version;
            ...
            const args = argsOrState as BuildAReactNativeAppArgs | undefined;
            ...
            inputs['node_version'] = args.node_version;
        ...
        inputs['type'] = 'NATIVE_BUILD_MAC_REACT';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(BuildAReactNativeApp.__pulumiType, name, inputs, opts);
    }
}
