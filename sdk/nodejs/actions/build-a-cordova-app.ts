...
export interface BuildACordovaAppState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type BuildACordovaAppArgs = AsInputs<BuildACordovaAppState>;

export interface BuildACordovaAppProps {
    url: string;
    html_url: string;
    action_id: number;
    commands: string[];
 ...
 */
export class BuildACordovaApp extends CustomResource {
    static __pulumiType = 'buddy:action:BuildACordovaApp';

    static get(name: string, id: Input<ID>, state?: Partial<BuildACordovaAppState>, opts?: CustomResourceOptions) {
        return new BuildACordovaApp(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is BuildACordovaApp {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === BuildACordovaApp.__pulumiType;
    }
    ...
    type!: Output<'NATIVE_BUILD_MAC_CORDOVA'>;
    ...
    constructor(name: string, argsOrState: BuildACordovaAppArgs | BuildACordovaAppState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as BuildACordovaAppState | undefined;
            ...
            const args = argsOrState as BuildACordovaAppArgs | undefined;
        ...
        inputs['type'] = 'NATIVE_BUILD_MAC_CORDOVA';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(BuildACordovaApp.__pulumiType, name, inputs, opts);
    }
}
