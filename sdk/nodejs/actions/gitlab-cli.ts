...
export interface GitLabCLIState {
    project_name: string;
    pipeline_id: number;
    /**
...
export interface GitLabCLIProps {
    url: string;
    html_url: string;
    action_id: number;
    execute_commands: string;
 ...
 */
export class GitLabCLI extends CustomResource {
    static __pulumiType = 'buddy:action:GitLabCLI';

    static get(name: string, id: Input<ID>, state?: Partial<GitLabCLIState>, opts?: CustomResourceOptions) {
        return new GitLabCLI(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is GitLabCLI {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === GitLabCLI.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: GitLabCLIArgs | GitLabCLIState, opts?: CustomResourceOptions) {
        ...
        if (opts.id) {
            const state = argsOrState as GitLabCLIState | undefined;
            ...
            const args = argsOrState as GitLabCLIArgs | undefined;
        ...
        inputs['type'] = 'GIT_LAB_CLI';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(GitLabCLI.__pulumiType, name, inputs, opts);
    }
}
