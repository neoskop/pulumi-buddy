...
export interface DownloadFTPSState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type DownloadFTPSArgs = AsInputs<DownloadFTPSState>;

export interface DownloadFTPSProps {
    url: string;
    html_url: string;
    action_id: number;
    destination_path: string;
 ...
 */
export class DownloadFTPS extends CustomResource {
    static __pulumiType = 'buddy:action:DownloadFTPS';

    static get(name: string, id: Input<ID>, state?: Partial<DownloadFTPSState>, opts?: CustomResourceOptions) {
        return new DownloadFTPS(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is DownloadFTPS {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === DownloadFTPS.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: DownloadFTPSArgs | DownloadFTPSState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as DownloadFTPSState | undefined;
            ...
            const args = argsOrState as DownloadFTPSArgs | undefined;
        ...
        inputs['type'] = 'DOWNLOAD_FTPS';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(DownloadFTPS.__pulumiType, name, inputs, opts);
    }
}
