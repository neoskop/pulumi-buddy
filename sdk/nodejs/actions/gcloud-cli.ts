...
export class GCloudCLI extends CustomResource {
    ...
    static isInstance(obj: any): obj is GCloudCLI {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === GCloudCLI.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: GCloudCLIArgs | GCloudCLIState, opts?: CustomResourceOptions) {
        ...
        inputs['type'] = 'GOOGLE_CLOUD_CLI';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(GCloudCLI.__pulumiType, name, inputs, opts);
    }
}
