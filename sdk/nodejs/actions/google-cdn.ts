...
export class GoogleCDN extends CustomResource {
    ...
    static isInstance(obj: any): obj is GoogleCDN {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === GoogleCDN.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: GoogleCDNArgs | GoogleCDNState, opts?: CustomResourceOptions) {
        ...
        inputs['type'] = 'GOOGLE_CDN_INVALIDATE';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(GoogleCDN.__pulumiType, name, inputs, opts);
    }
}
