...
export interface NewRelicCLIState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type NewRelicCLIArgs = AsInputs<NewRelicCLIState>;

export interface NewRelicCLIProps {
    url: string;
    html_url: string;
    action_id: number;
    execute_commands: string[];
 ...
 */
export class NewRelicCLI extends CustomResource {
    static __pulumiType = 'buddy:action:NewRelicCLI';

    static get(name: string, id: Input<ID>, state?: Partial<NewRelicCLIState>, opts?: CustomResourceOptions) {
        return new NewRelicCLI(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is NewRelicCLI {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === NewRelicCLI.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState: NewRelicCLIArgs | NewRelicCLIState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as NewRelicCLIState | undefined;
            ...
            const args = argsOrState as NewRelicCLIArgs | undefined;
        ...
        inputs['type'] = 'NEW_RELIC_CLI';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(NewRelicCLI.__pulumiType, name, inputs, opts);
    }
}
