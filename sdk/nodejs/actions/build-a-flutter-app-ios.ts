...
export interface BuildAFlutterAppiOSState {
    project_name: string;
    pipeline_id: number;
    /**
...
export type BuildAFlutterAppiOSArgs = AsInputs<BuildAFlutterAppiOSState>;

export interface BuildAFlutterAppiOSProps {
    url: string;
    html_url: string;
    action_id: number;
    commands: string[];
 ...
 */
export class BuildAFlutterAppiOS extends CustomResource {
    static __pulumiType = 'buddy:action:BuildAFlutterAppiOS';

    static get(name: string, id: Input<ID>, state?: Partial<BuildAFlutterAppiOSState>, opts?: CustomResourceOptions) {
        return new BuildAFlutterAppiOS(name, state as any, { ...opts, id });
    }

    static isInstance(obj: any): obj is BuildAFlutterAppiOS {
        if (null == obj) {
            return false;
        }

        return obj['__pulumiType'] === BuildAFlutterAppiOS.__pulumiType;
    }
    ...
    type!: Output<'NATIVE_BUILD_MAC_FLUTTER'>;
    ...
    constructor(name: string, argsOrState: BuildAFlutterAppiOSArgs | BuildAFlutterAppiOSState, opts?: CustomResourceOptions) {
        const inputs: Inputs = {};
        if (!opts) {
            opts = {};
        }
        ...
        if (opts.id) {
            const state = argsOrState as BuildAFlutterAppiOSState | undefined;
            ...
            const args = argsOrState as BuildAFlutterAppiOSArgs | undefined;
        ...
        inputs['type'] = 'NATIVE_BUILD_MAC_FLUTTER';
        inputs['url'] = undefined;
        inputs['html_url'] = undefined;
        inputs['action_id'] = undefined;

        super(BuildAFlutterAppiOS.__pulumiType, name, inputs, opts);
    }
}
